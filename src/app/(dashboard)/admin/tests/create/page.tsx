    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Design and configure exams for your students</p>
        </div>
        <button
          onClick={handleSave}
                ...
                {questions.length === 0 ? (
                  ...
                  questions.map((q, idx) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs ${activeQIndex === idx ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                          {idx + 1}
                        </div>
                        ...
                        <button onClick={(e) => { e.stopPropagation(); removeQuestion(idx); }} className="text-slate-400 hover:text-red-500 p-1">
                          <Trash2 size={16} />
                        </button>
                      </div>
                    );
